"""
angle2pnw — shared manual-steering-override ("human turn") detection for Ford lateral control,
ported from BluePilot (alan-polk), bluepilotdev/bp-7.0
opendbc_repo/opendbc/sunnypilot/car/ford/human_turn.py.

Port is a 1:1 numeric port (unchanged constants and logic). pnw currently wires this only from
lateral_angle_pnw.LateralAngleExt (angle-primary mode) — lateral_curv_pnw.LateralCurvExt has its
own, differently-shaped human-turn reset (see LateralCurvExt.human_turn / HUMAN_TURN_ANGLE_DEG in
that file) that pre-dates this port and is left untouched.
"""

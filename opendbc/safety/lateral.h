...
// mads2pnw: controls_allowed_lateral -- the parallel lateral-authority flag. Every gate
// below becomes (controls_allowed || controls_allowed_lateral); nothing is removed.
#include "opendbc/safety/pnw/mads.h"
